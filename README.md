...
Products with `unvalidated` or `not_checked` status use warning styling, never
success styling. A completed validation fixture includes an explicit contract;
a nonempty exploratory table alone does not count as validated.
